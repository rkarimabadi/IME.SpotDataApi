...
namespace IME.SpotDataApi.Services.MainGroupLevel
{
    ...
    public class GroupService : IGroupService
    {
        ...
        public GroupService(IDbContextFactory<AppDataContext> contextFactory, IDateHelper dateHelper, ICacheService cacheService)
        {
        ...
        {
            string cacheKey = $"Group_Header_{groupId}";
        ...
        {
            string cacheKey = $"Group_Hierarchy_{groupId}";
            return await _cacheService.GetOrCreateAsync(cacheKey, async () =>
            {
                using var context = await _contextFactory.CreateDbContextAsync();
        ...
        {
            string cacheKey = $"Group_ActiveSubGroups_{groupId}";
            return await _cacheService.GetOrCreateAsync(cacheKey, async () =>
            {
                using var context = await _contextFactory.CreateDbContextAsync();
        ...
        {
            string cacheKey = $"Group_SubGroupActivities_{groupId}";
            return await _cacheService.GetOrCreateAsync(cacheKey, async () =>
            {
                using var context = await _contextFactory.CreateDbContextAsync();
                var todayPersian = _dateHelper.GetPersian(DateTime.Now);
        ...
        {
            string cacheKey = $"Group_UpcomingOffers_{groupId}";
            return await _cacheService.GetOrCreateAsync(cacheKey, async () =>
            {
                using var context = await _contextFactory.CreateDbContextAsync();
                var todayPersian = _dateHelper.GetPersian(DateTime.Now);
        ...
        {
            string cacheKey = $"Group_TodayOffers_{groupId}";
            return await _cacheService.GetOrCreateAsync(cacheKey, async () =>
            {
                using var context = await _contextFactory.CreateDbContextAsync();
                var todayPersian = _dateHelper.GetPersian(DateTime.Now);
