...
namespace IME.SpotDataApi.Services.MainGroupLevel
{
    ...
    public class SubGroupService : ISubGroupService
    {
        ...
        public SubGroupService(IDbContextFactory<AppDataContext> contextFactory, IDateHelper dateHelper, ICacheService cacheService)
        {
        ...
        {
            string cacheKey = $"SubGroup_Header_{subGroupId}";
        ...
        {
            string cacheKey = $"SubGroup_Hierarchy_{subGroupId}";
            return await _cacheService.GetOrCreateAsync(cacheKey, async () =>
            {
                using var context = await _contextFactory.CreateDbContextAsync();
        ...
        {
            string cacheKey = $"SubGroup_ActiveCommodities_{subGroupId}";
            return await _cacheService.GetOrCreateAsync(cacheKey, async () =>
            {
                using var context = await _contextFactory.CreateDbContextAsync();
        ...
        {
            string cacheKey = $"SubGroup_CommodityActivities_{subGroupId}";
            return await _cacheService.GetOrCreateAsync(cacheKey, async () =>
            {
                using var context = await _contextFactory.CreateDbContextAsync();
                var todayPersian = _dateHelper.GetPersian(DateTime.Now);
        ...
        {
            string cacheKey = $"SubGroup_OfferHistory_{subGroupId}";
            return await _cacheService.GetOrCreateAsync(cacheKey, async () =>
            {
                using var context = await _contextFactory.CreateDbContextAsync();
                var todayPersian = _dateHelper.GetPersian(DateTime.Now);
